...
def insert_func():
    ...
    travel_box.grid(row=0, column=1, columnspan=4,
                    padx=10, pady=20, sticky=tk.N)
    ...
    phn_entry = tk.Entry(contact_box, width=40,
                         bg='#F0F0F0', textvariable=phone)
    ...
    phn_entry.grid(row=2, column=1, padx=10, sticky=tk.N, pady=10)
